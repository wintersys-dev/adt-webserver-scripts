...
${HOME}/services/email/SendEmail.sh "A AUTHENTICATION SERVER HAS BEEN SUCCESSFULLY BUILT" "An authentication server has been successfully built and primed as is rebooting ready for use" "INFO"
