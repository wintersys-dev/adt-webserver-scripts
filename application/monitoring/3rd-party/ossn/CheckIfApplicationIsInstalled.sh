#!/bin/sh
###########################################################################################################
# Description:On the build machine you can set directories and files corresponding to ossn that this
# script will compare against the ossn you have installed for integrity reasons. This script checks 
...
# ossn you will find in the build-machine repository at:
#
