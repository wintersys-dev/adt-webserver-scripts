...
/bin/sed -i "s/XXXXPHPVERSIONXXXX/${PHP_VERSION}/" ${HOME}/webserver/configuration/authenticator/lighttpd/lighttpd.conf
/bin/sed -i "s/XXXXPORTXXXX/${port}/" ${HOME}/webserver/configuration/authenticator/lighttpd/lighttpd.conf
/bin/sed -i "s/XXXXWEBSITEURLXXXX/${WEBSITE_URL}/g" ${HOME}/webserver/configuration/authenticator/lighttpd/lighttpd.conf
/bin/sed -i "s,XXXXHOMEXXXX,${HOME},g" ${HOME}/webserver/configuration/authenticator/lighttpd/lighttpd.conf

if ( [ -f ${HOME}/webserver/configuration/authenticator/lighttpd/mimetypes.conf ] )
then
	/bin/cp ${HOME}/webserver/configuration/authenticator/lighttpd/mimetypes.conf /etc/lighttpd/mimetypes.conf
fi
