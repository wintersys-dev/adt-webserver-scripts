...
then
  ...
  /bin/echo "XXXX_BORKED_XXXX" >> /etc/nginx/sites-available/${WEBSITE_NAME}
fi
...
then
  ...
  /bin/echo "XXXX_BORKED_XXXX" >> /etc/apache2/sites-available/${WEBSITE_NAME}
fi
...
then
  ...
  /bin/echo "XXXX_BORKED_XXXX" >> /etc/lighttpd/lighttpd.conf
fi
