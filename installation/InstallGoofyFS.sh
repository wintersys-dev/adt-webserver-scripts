...
do
	if ( [ "${BUILDOS}" = "ubuntu" ] )
	then
		${HOME}/installation/InstallLibFuse2.sh ${BUILDOS}
...
then
	${HOME}/services/email/SendEmail.sh "INSTALLATION ERROR GOOFYS" "I believe that goofys hasn't installed correctly, please investigate" "ERROR"
else
