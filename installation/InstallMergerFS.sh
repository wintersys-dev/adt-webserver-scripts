...
then
        ${HOME}/services/email/SendEmail.sh "INSTALLATION ERROR MERGERFS" "I believe that mergerfs hasn't installed correctly, please investigate" "ERROR"
else
