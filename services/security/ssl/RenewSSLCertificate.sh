...
if ( [ "`${HOME}/services/datastore/operations/ListFromDatastore.sh "ssl" "fullchain.pem"`" != "" ] && [ "`${HOME}/services/datastore/operations/ListFromDatastore.sh "ssl" "privkey.pem"`" != "" ] )
then
        if ( [ ! -d ${HOME}/ssl/live/${WEBSITE_URL}/new ] )
        then
                /bin/mkdir -p ${HOME}/ssl/live/${WEBSITE_URL}/new 
        fi
        ${HOME}/services/datastore/operations/GetFromDatastore.sh "ssl" "fullchain.pem" "${HOME}/ssl/live/${WEBSITE_URL}/new"
        ${HOME}/services/datastore/operations/GetFromDatastore.sh "ssl" "privkey.pem" "${HOME}/ssl/live/${WEBSITE_URL}/new"
fi
