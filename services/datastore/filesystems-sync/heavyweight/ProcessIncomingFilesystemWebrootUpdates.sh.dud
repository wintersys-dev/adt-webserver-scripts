...
if ( [ "`${HOME}/services/datastore/operations/ListFromDatastore.sh "${bucket_type}" "filesystem-sync/${bucket_type}/historical/additions/" "${target_directory}"`" != "" ] )
then
        additions_present="1"
fi

if ( [ "`${HOME}/services/datastore/operations/ListFromDatastore.sh "${bucket_type}" "filesystem-sync/${bucket_type}/historical/deletions/" "${target_directory}"`" != "" ] )
then
        deletions_present="1"
fi
...
then
        additions="`${HOME}/services/datastore/operations/ListFromDatastore.sh "${bucket_type}" "filesystem-sync/${bucket_type}/historical/additions/" "${target_directory}"`"
        for addition in ${additions}
        do
                ${HOME}/services/datastore/operations/GetFromDatastore.sh "${bucket_type}" "filesystem-sync/${bucket_type}/historical/additions/${addition}" "${HOME}/runtime/filesystem_sync/${bucket_type}/historical/incoming/additions"  "${target_directory}"
        done
fi

if ( [ "${deletions_present}" = "1" ] )
then
        deletions="`${HOME}/services/datastore/operations/ListFromDatastore.sh "${bucket_type}" "filesystem-sync/${bucket_type}/historical/deletions/" "${target_directory}"`"
        for deletion in ${deletions}
        do
                ${HOME}/services/datastore/operations/GetFromDatastore.sh "${bucket_type}" "filesystem-sync/${bucket_type}/historical/deletions/${deletion}" "${HOME}/runtime/filesystem_sync/${bucket_type}/historical/incoming/deletions" "${target_directory}"
        done
fi
