...
if ( [ "`${HOME}/services/datastore/operations/ListFromDatastore.sh "${bucket_type}" "filesystem-sync/${bucket_type}/additions/" "${target_directory}"`" != "" ] )
then
        additions_present="1"
fi

if ( [ "`${HOME}/services/datastore/operations/ListFromDatastore.sh "${bucket_type}" "filesystem-sync/${bucket_type}/deletions/" "${target_directory}"`" != "" ] )
then
        deletions_present="1"
fi
...
then
        additions="`${HOME}/services/datastore/operations/ListFromDatastore.sh "${bucket_type}" "filesystem-sync/${bucket_type}/additions/" "${target_directory}"`"
        for addition in ${additions}
        do
                ${HOME}/services/datastore/operations/GetFromDatastore.sh "${bucket_type}" "filesystem-sync/${bucket_type}/additions/${addition}" "${HOME}/runtime/filesystem_sync/${bucket_type}/incoming/additions" "${target_directory}"
        done
fi
...
then
        ...
        do
                ${HOME}/services/datastore/operations/GetFromDatastore.sh "${bucket_type}" "filesystem-sync/${bucket_type}/deletions/${deletion}" "${HOME}/runtime/filesystem_sync/${bucket_type}/incoming/deletions" "${target_directory}"
        done
fi
