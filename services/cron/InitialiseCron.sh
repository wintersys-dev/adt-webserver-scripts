...
then
	...
	then
		...
		/bin/echo "*/1 * * * * export HOME="${HOME}" && /bin/sleep 20 && ${HOME}/webserver/configuration/authenticator/${AUTHENTICATOR_TYPE}/AcceptIPAddresses.sh" >> /var/spool/cron/crontabs/root
	...
	then
		/bin/echo "*/1 * * * * export HOME="${HOME}" && ${HOME}/webserver/configuration/authenticator/${AUTHENTICATOR_TYPE}/GenerateBasicAuthConfig.sh" >> /var/spool/cron/crontabs/root
		/bin/echo "*/1 * * * * export HOME="${HOME}" && /bin/sleep 10 && ${HOME}/webserver/configuration/authenticator/${AUTHENTICATOR_TYPE}/GenerateBasicAuthConfig.sh" >> /var/spool/cron/crontabs/root
		/bin/echo "*/1 * * * * export HOME="${HOME}" && /bin/sleep 20 && ${HOME}/webserver/configuration/authenticator/${AUTHENTICATOR_TYPE}/GenerateBasicAuthConfig.sh" >> /var/spool/cron/crontabs/root
...
then
	...
	then
		/bin/echo "*/1 * * * * export HOME="${HOME}" && /bin/sleep 40 && ${HOME}/webserver/configuration/reverseproxy/RemoveOldIPFromReverseProxyIPList.sh" >> /var/spool/cron/crontabs/root
		/bin/echo "*/1 * * * * export HOME="${HOME}" && /bin/sleep 20 && ${HOME}/webserver/configuration/reverseproxy/RemoveOldIPFromReverseProxyIPList.sh" >> /var/spool/cron/crontabs/root
		/bin/echo "*/1 * * * * export HOME="${HOME}" && /bin/sleep 30 && ${HOME}/webserver/configuration/reverseproxy/EnsureReverseProxyWebserverIPs.sh" >> /var/spool/cron/crontabs/root
		/bin/echo "*/1 * * * * export HOME="${HOME}" && ${HOME}/webserver/configuration/reverseproxy/EnsureReverseProxyWebserverIPs.sh" >> /var/spool/cron/crontabs/root
	fi
	...
	then
		/bin/echo "*/1 * * * * export HOME="${HOME}" && /bin/sleep 2 && ${HOME}/services/datastore/filesystems-sync/heavyweight/FileSystemsSyncingController.sh '2' '/var/www/html' 'webroot-sync'" >> /var/spool/cron/crontabs/root
		/bin/echo "*/1 * * * * export HOME="${HOME}" && /bin/sleep 15 && ${HOME}/services/datastore/filesystems-sync/heavyweight/FileSystemsSyncingController.sh '15' '/var/www/html' 'webroot-sync'" >> /var/spool/cron/crontabs/root
		/bin/echo "*/1 * * * * export HOME="${HOME}" && /bin/sleep 30 && ${HOME}/services/datastore/filesystems-sync/heavyweight/FileSystemsSyncingController.sh '30' '/var/www/html' 'webroot-sync'" >> /var/spool/cron/crontabs/root
	...
	then
		...
		then
			/bin/echo "*/1 * * * * export HOME="${HOME}" && ${HOME}/webserver/configuration/reverseproxy/wire-guard/ObtainWireguardEmails.sh" >> /var/spool/cron/crontabs/root
			/bin/echo "*/1 * * * * export HOME="${HOME}" && /bin/sleep 5 && ${HOME}/webserver/configuration/reverseproxy/wire-guard/ObtainWireguardEmails.sh" >> /var/spool/cron/crontabs/root
			/bin/echo "*/1 * * * * export HOME="${HOME}" && /bin/sleep 10 && ${HOME}/webserver/configuration/reverseproxy/wire-guard/ObtainWireguardEmails.sh" >> /var/spool/cron/crontabs/root
			/bin/echo "*/1 * * * * export HOME="${HOME}" && /bin/sleep 15 && ${HOME}/webserver/configuration/reverseproxy/wire-guard/ObtainWireguardEmails.sh" >> /var/spool/cron/crontabs/root
			/bin/echo "*/1 * * * * export HOME="${HOME}" && /bin/sleep 20 && ${HOME}/webserver/configuration/reverseproxy/wire-guard/ObtainWireguardEmails.sh" >> /var/spool/cron/crontabs/root
			/bin/echo "*/1 * * * * export HOME="${HOME}" && /bin/sleep 25 && ${HOME}/webserver/configuration/reverseproxy/wire-guard/ObtainWireguardEmails.sh" >> /var/spool/cron/crontabs/root
			/bin/echo "*/1 * * * * export HOME="${HOME}" && /bin/sleep 30 && ${HOME}/webserver/configuration/reverseproxy/wire-guard/ObtainWireguardEmails.sh" >> /var/spool/cron/crontabs/root
			/bin/echo "*/1 * * * * export HOME="${HOME}" && /bin/sleep 35 && ${HOME}/webserver/configuration/reverseproxy/wire-guard/ObtainWireguardEmails.sh" >> /var/spool/cron/crontabs/root
			/bin/echo "*/1 * * * * export HOME="${HOME}" && /bin/sleep 40 && ${HOME}/webserver/configuration/reverseproxy/wire-guard/ObtainWireguardEmails.sh" >> /var/spool/cron/crontabs/root
			/bin/echo "*/1 * * * * export HOME="${HOME}" && /bin/sleep 45 && ${HOME}/webserver/configuration/reverseproxy/wire-guard/ObtainWireguardEmails.sh" >> /var/spool/cron/crontabs/root
			/bin/echo "*/1 * * * * export HOME="${HOME}" && /bin/sleep 50 && ${HOME}/webserver/configuration/reverseproxy/wire-guard/ObtainWireguardEmails.sh" >> /var/spool/cron/crontabs/root
			/bin/echo "*/1 * * * * export HOME="${HOME}" && /bin/sleep 55 && ${HOME}/webserver/configuration/reverseproxy/wire-guard/ObtainWireguardEmails.sh" >> /var/spool/cron/crontabs/root
		fi
	fi
